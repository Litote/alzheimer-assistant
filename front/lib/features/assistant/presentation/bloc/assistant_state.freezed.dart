...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Idle value)?  idle,TResult Function( Starting value)?  starting,TResult Function( Connecting value)?  connecting,TResult Function( Listening value)?  listening,TResult Function( Speaking value)?  speaking,TResult Function( AssistantError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Idle() when idle != null:
return idle(_that);case Starting() when starting != null:
return starting(_that);case Connecting() when connecting != null:
return connecting(_that);case Listening() when listening != null:
return listening(_that);case Speaking() when speaking != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Idle value)  idle,required TResult Function( Starting value)  starting,required TResult Function( Connecting value)  connecting,required TResult Function( Listening value)  listening,required TResult Function( Speaking value)  speaking,required TResult Function( AssistantError value)  error,}){
final _that = this;
switch (_that) {
case Idle():
return idle(_that);case Starting():
return starting(_that);case Connecting():
return connecting(_that);case Listening():
return listening(_that);case Speaking():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Idle value)?  idle,TResult? Function( Starting value)?  starting,TResult? Function( Connecting value)?  connecting,TResult? Function( Listening value)?  listening,TResult? Function( Speaking value)?  speaking,TResult? Function( AssistantError value)?  error,}){
final _that = this;
switch (_that) {
case Idle() when idle != null:
return idle(_that);case Starting() when starting != null:
...
/// @nodoc
abstract mixin class $IdleCopyWith<$Res> implements $AssistantStateCopyWith<$Res> {
