...
return speechRecognized(_that);case _:
  return orElse();
...
return speechRecognized(_that.text);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveEventReceivedCopyWith<LiveEventReceived> get copyWith => _$LiveEventReceivedCopyWithImpl<LiveEventReceived>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveEventReceived&&(identical(other.event, event) || other.event == event));
}
...
/// @nodoc
abstract mixin class $LiveEventReceivedCopyWith<$Res> implements $AssistantEventCopyWith<$Res> {
  factory $LiveEventReceivedCopyWith(LiveEventReceived value, $Res Function(LiveEventReceived) _then) = _$LiveEventReceivedCopyWithImpl;
@useResult
$Res call({
 LiveEvent event
});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is AudioPlaybackFinished);
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SpeechRecognizedCopyWith<SpeechRecognized> get copyWith => _$SpeechRecognizedCopyWithImpl<SpeechRecognized>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is SpeechRecognized&&(identical(other.text, text) || other.text == text));
}
...
/// @nodoc
abstract mixin class $SpeechRecognizedCopyWith<$Res> implements $AssistantEventCopyWith<$Res> {
  factory $SpeechRecognizedCopyWith(SpeechRecognized value, $Res Function(SpeechRecognized) _then) = _$SpeechRecognizedCopyWithImpl;
@useResult
$Res call({
 String text
});
