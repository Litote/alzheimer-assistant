...
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveEvent);
}
...
$LiveAudioChunkCopyWith<LiveAudioChunk> get copyWith => _$LiveAudioChunkCopyWithImpl<LiveAudioChunk>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveAudioChunk&&const DeepCollectionEquality().equals(other.bytes, bytes));
}
...
/// @nodoc
abstract mixin class $LiveAudioChunkCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveAudioChunkCopyWith(LiveAudioChunk value, $Res Function(LiveAudioChunk) _then) = _$LiveAudioChunkCopyWithImpl;
@useResult
$Res call({
 Uint8List bytes
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveTextDeltaCopyWith<LiveTextDelta> get copyWith => _$LiveTextDeltaCopyWithImpl<LiveTextDelta>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveTextDelta&&(identical(other.text, text) || other.text == text));
}
...
/// @nodoc
abstract mixin class $LiveTextDeltaCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveTextDeltaCopyWith(LiveTextDelta value, $Res Function(LiveTextDelta) _then) = _$LiveTextDeltaCopyWithImpl;
@useResult
$Res call({
 String text
});
...
class LiveCallPhone implements LiveEvent {
  const LiveCallPhone({required this.callId, required this.contactName, required this.exactMatch});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveCallPhoneCopyWith<LiveCallPhone> get copyWith => _$LiveCallPhoneCopyWithImpl<LiveCallPhone>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveCallPhone&&(identical(other.callId, callId) || other.callId == callId)&&(identical(other.contactName, contactName) || other.contactName == contactName)&&(identical(other.exactMatch, exactMatch) || other.exactMatch == exactMatch));
}


@override
int get hashCode {
    return Object.hash(runtimeType,callId,contactName,exactMatch);
}
...
/// @nodoc
abstract mixin class $LiveCallPhoneCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveCallPhoneCopyWith(LiveCallPhone value, $Res Function(LiveCallPhone) _then) = _$LiveCallPhoneCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of LiveEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? callId = null,Object? contactName = null,Object? exactMatch = null,}) {
...
as String,exactMatch: null == exactMatch ? _self.exactMatch : exactMatch // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveTurnComplete);
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveInputTranscriptionCopyWith<LiveInputTranscription> get copyWith => _$LiveInputTranscriptionCopyWithImpl<LiveInputTranscription>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveInputTranscription&&(identical(other.text, text) || other.text == text));
}
...
/// @nodoc
abstract mixin class $LiveInputTranscriptionCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveInputTranscriptionCopyWith(LiveInputTranscription value, $Res Function(LiveInputTranscription) _then) = _$LiveInputTranscriptionCopyWithImpl;
@useResult
$Res call({
 String text
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveOutputTranscriptionCopyWith<LiveOutputTranscription> get copyWith => _$LiveOutputTranscriptionCopyWithImpl<LiveOutputTranscription>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveOutputTranscription&&(identical(other.text, text) || other.text == text));
}
...
/// @nodoc
abstract mixin class $LiveOutputTranscriptionCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveOutputTranscriptionCopyWith(LiveOutputTranscription value, $Res Function(LiveOutputTranscription) _then) = _$LiveOutputTranscriptionCopyWithImpl;
@useResult
$Res call({
 String text
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveToolStatusCopyWith<LiveToolStatus> get copyWith => _$LiveToolStatusCopyWithImpl<LiveToolStatus>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveToolStatus&&(identical(other.label, label) || other.label == label));
}
...
/// @nodoc
abstract mixin class $LiveToolStatusCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveToolStatusCopyWith(LiveToolStatus value, $Res Function(LiveToolStatus) _then) = _$LiveToolStatusCopyWithImpl;
@useResult
$Res call({
 String label
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveSessionInfoCopyWith<LiveSessionInfo> get copyWith => _$LiveSessionInfoCopyWithImpl<LiveSessionInfo>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveSessionInfo&&(identical(other.welcome, welcome) || other.welcome == welcome));
}


@override
int get hashCode {
    return Object.hash(runtimeType,welcome);
}
...
/// @nodoc
abstract mixin class $LiveSessionInfoCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveSessionInfoCopyWith(LiveSessionInfo value, $Res Function(LiveSessionInfo) _then) = _$LiveSessionInfoCopyWithImpl;
@useResult
$Res call({
 String welcome
});
...
/// Create a copy of LiveEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? welcome = null,}) {
  return _then(LiveSessionInfo(
null == welcome ? _self.welcome : welcome // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveSessionEstablishedCopyWith<LiveSessionEstablished> get copyWith => _$LiveSessionEstablishedCopyWithImpl<LiveSessionEstablished>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveSessionEstablished&&(identical(other.sessionId, sessionId) || other.sessionId == sessionId));
}
...
/// @nodoc
abstract mixin class $LiveSessionEstablishedCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveSessionEstablishedCopyWith(LiveSessionEstablished value, $Res Function(LiveSessionEstablished) _then) = _$LiveSessionEstablishedCopyWithImpl;
@useResult
$Res call({
 String sessionId
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LiveImageUrlCopyWith<LiveImageUrl> get copyWith => _$LiveImageUrlCopyWithImpl<LiveImageUrl>(this, _$identity);



@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is LiveImageUrl&&(identical(other.url, url) || other.url == url));
}
...
/// @nodoc
abstract mixin class $LiveImageUrlCopyWith<$Res> implements $LiveEventCopyWith<$Res> {
  factory $LiveImageUrlCopyWith(LiveImageUrl value, $Res Function(LiveImageUrl) _then) = _$LiveImageUrlCopyWithImpl;
@useResult
$Res call({
 String url
});
...
/// @nodoc
class _$LiveImageUrlCopyWithImpl<$Res>
    implements $LiveImageUrlCopyWith<$Res> {
